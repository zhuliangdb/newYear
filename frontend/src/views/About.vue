...
const techStack = ref([
  {
    name: 'Vue 3',
    description: '前端框架，使用Composition API构建响应式界面',
    icon: '⚡'
  },
  {
    name: 'Spring Boot',
    description: '后端框架，构建RESTful API',
    icon: '☕'
  },
  {
    name: 'Vite',
    description: '前端构建工具，提供快速的开发体验',
    icon: '🚀'
  },
  {
    name: 'Pinia',
    description: '状态管理库，替代Vuex的轻量级方案',
    icon: '📦'
  },
  {
    name: 'Firebase',
    description: '后端服务，提供实时数据库和认证功能',
    icon: '🔥'
  },
  {
    name: 'Three.js',
    description: '3D库，创建沉浸式的3D体验',
    icon: '🎨'
  }
])
</script>
